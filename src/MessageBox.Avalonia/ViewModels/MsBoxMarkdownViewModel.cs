...
{
    public class MsBoxMarkdownViewModel : AbstractMsBoxViewModel
    {
        ...
        public MsBoxMarkdownViewModel(MessageBoxStandardParams @params, MsBoxStandardWindow msBoxStandardWindow) :
